		...
		options.add(new OptionsEntryButton("general", new Button(0, 0, 100, 20, StringTextComponent.EMPTY, w -> {
			minecraft.setScreen(new GuiOptions(GuiConfigWaila.this, "general") {
				...
				public OptionsListWidget getOptions() {
					...
					if (ModList.get().isLoaded("appliedenergistics2")) options.add(new OptionsEntryValueBoolean("only_show_smart_nodes", general.getOnlyShowSmartNodes(), general::setOnlyShowSmartNodes));
